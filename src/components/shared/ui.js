...
export const btn = {
  ...
  primary:
    "px-8 pt-[0.95rem] pb-[0.55rem] rounded-lg bg-[color:var(--emphasis)] text-white text-xl font-bold tracking-wide cursor-pointer transition-all hover:opacity-90 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--emphasis)] disabled:opacity-40 disabled:cursor-not-allowed disabled:active:scale-100",
  // Quiet bordered action
  secondary:
    "px-8 pt-[0.95rem] pb-[0.55rem] rounded-lg border border-[color:var(--text-color)]/25 bg-white text-[color:var(--text-color)] text-xl font-semibold tracking-wide cursor-pointer transition-all hover:bg-black/5 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--text-color)] disabled:opacity-40 disabled:cursor-not-allowed",
  // Destructive
  danger:
    "px-8 pt-[0.95rem] pb-[0.55rem] rounded-lg border border-red-300 bg-white text-red-600 text-xl font-semibold tracking-wide cursor-pointer transition-all hover:bg-red-600 hover:text-white hover:border-red-600 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 disabled:opacity-40 disabled:cursor-not-allowed",
  // Solid destructive (confirm step)
  dangerSolid:
    "px-8 pt-[0.95rem] pb-[0.55rem] rounded-lg bg-red-600 text-white text-xl font-bold tracking-wide cursor-pointer transition-all hover:bg-red-700 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 disabled:opacity-40 disabled:cursor-not-allowed",
  // Positive action (confirm reservation, record payment)
  success:
    "px-8 pt-[0.95rem] pb-[0.55rem] rounded-lg bg-green-700 text-white text-xl font-bold tracking-wide cursor-pointer transition-all hover:bg-green-600 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-700 disabled:opacity-40 disabled:cursor-not-allowed",
  // Compact variants for table rows — always laid out horizontally
  rowPrimary:
    "px-5 pt-[0.7rem] pb-[0.3rem] rounded-lg bg-[color:var(--emphasis)] text-white text-lg font-bold tracking-wide cursor-pointer whitespace-nowrap transition-all hover:opacity-90 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--emphasis)] disabled:opacity-40 disabled:cursor-not-allowed",
  rowSecondary:
    "px-5 pt-[0.7rem] pb-[0.3rem] rounded-lg border border-[color:var(--text-color)]/25 bg-white text-[color:var(--text-color)] text-lg font-semibold tracking-wide cursor-pointer whitespace-nowrap transition-all hover:bg-black/5 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--text-color)] disabled:opacity-40 disabled:cursor-not-allowed",
  rowDanger:
    "px-5 pt-[0.7rem] pb-[0.3rem] rounded-lg border border-red-300 bg-white text-red-600 text-lg font-semibold tracking-wide cursor-pointer whitespace-nowrap transition-all hover:bg-red-600 hover:text-white hover:border-red-600 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 disabled:opacity-40 disabled:cursor-not-allowed",
  rowSuccess:
    "px-5 pt-[0.7rem] pb-[0.3rem] rounded-lg bg-green-700 text-white text-lg font-bold tracking-wide cursor-pointer whitespace-nowrap transition-all hover:bg-green-600 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-700 disabled:opacity-40 disabled:cursor-not-allowed",
};

export const field = {
  label: "text-xl font-semibold text-[color:var(--text-color)]/70",
  input:
  ...
  select:
    "w-full border border-[color:var(--text-color)]/25 rounded-lg px-4 py-3 text-2xl bg-white text-[color:var(--text-color)] focus:outline-none focus:ring-2 focus:ring-[color:var(--emphasis)] focus:border-transparent transition-shadow cursor-pointer",
  textarea:
...
export const table = {
  ...
  th: "px-8 py-4 text-left whitespace-nowrap text-xl font-semibold uppercase tracking-wide text-[color:var(--text-color)]/60",
